...
export default function AdminDashboard() {
  ...
  const allUsers = [
    ...
    ...companies.map(c => ({ ...c, role: "company" as const,status: c.status as "approved" | "pending" | "rejected" | "banned", email: `contact@${c.name.toLowerCase().replace(/\s+/g, '')}.com`, avatar: c.logo, joinedAt: "2024-01-10T00:00:00Z" })),
